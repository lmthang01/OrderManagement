        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 login-sec">
                    <h2 class="text-center">Kích hoạt tài khoản</h2>
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1" class="text-capitalize">Confirm Password</label>
                            <input type="password" name="password_confirmation" class="form-control" placeholder="">
                            @error('password_confirmation')
                                <small id="" class="form-text text-danger">{{ $errors->first('password_confirmation') }}</small>
                            @enderror
                        </div>
                        <div class="form-group"
                            style="align-items: center; display: flex; justify-content: space-between;">
                            {{-- <a href="">Quên mật khẩu?</a> --}}
                            <button type="submit" class="btn btn-login float-right">Kích hoạt</button>
                        </div>
